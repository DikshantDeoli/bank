                    ...
                    <Box sx={{
                        ...
                        <FormGroup>
                            ...
                            <FormControl sx={{
                                ...
                                <InputLabel htmlFor="my-input">Withdraw Amount</InputLabel>
                                <Input id="my-input" type='number' aria-describedby="my-helper-text" />
                                <FormHelperText id="my-helper-text">Provide Withdraw Amount: 10,00,000 </FormHelperText>
                            </FormControl>
                            <FormControl sx={{
                                marginBottom: "0.8rem"
                            }}>
                                ...
                                <FormHelperText id="my-helper-text">Provide Description regarding Withdraw</FormHelperText>
                            </FormControl>
